...
<div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
  ...
  <div v-if="busOpen" class="w-full md:px-44 mt-28  border-t-2 border-b-0 pt-2 overflow-x-auto">
    ...
    <footer>
        <div class="px-28 pt-8 bg-gray-900 text-gray-200 border-b-2 border-green-600">
            <div class="max-w-7x1 mx-auto">
                <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                    <div class="mb-5">
                        <h4 class="text-2xl pb-4 underline">Company</h4>
                        <li class="mb-4 list-none"><span><svg class="inline  rounded-full mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="white" d="M12 0c-4.198 0-8 3.403-8 7.602 0 4.198 3.469 9.21 8 16.398 4.531-7.188 8-12.2 8-16.398 0-4.199-3.801-7.602-8-7.602zm0 11c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3z" /></svg>Ethiopia, Addis Ababa</span> </li>
                        <li class="mb-4 list-none"><span><svg class="inline mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="white" d="M0 3v18h24v-18h-24zm6.623 7.929l-4.623 5.712v-9.458l4.623 3.746zm-4.141-5.929h19.035l-9.517 7.713-9.518-7.713zm5.694 7.188l3.824 3.099 3.83-3.104 5.612 6.817h-18.779l5.513-6.812zm9.208-1.264l4.616-3.741v9.348l-4.616-5.607z" /></svg>cbe@combanket.et</span></li>
                        <li class="mb-4 list-none"><span><svg class="inline  mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill-rule="evenodd" clip-rule="evenodd">
                                    <path fill="white" d="M8.26 1.289l-1.564.772c-5.793 3.02 2.798 20.944 9.31 20.944.46 0 .904-.094 1.317-.284l1.542-.755-2.898-5.594-1.54.754c-.181.087-.384.134-.597.134-2.561 0-6.841-8.204-4.241-9.596l1.546-.763-2.875-5.612zm7.746 22.711c-5.68 0-12.221-11.114-12.221-17.832 0-2.419.833-4.146 2.457-4.992l2.382-1.176 3.857 7.347-2.437 1.201c-1.439.772 2.409 8.424 3.956 7.68l2.399-1.179 3.816 7.36s-2.36 1.162-2.476 1.215c-.547.251-1.129.376-1.733.376" /></svg>
                    ...
                    <div class="mb-5">
                        <h4 class="text-2xl mb-4 underline">Useful Links</h4>
                        <ul>
                            <li class="pb-4"><svg class="inline  " width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                                    <path fill="white" d="M12 0c-6.623 0-12 5.377-12 12s5.377 12 12 12 12-5.377 12-12-5.377-12-12-12zm0 1c-6.071 0-11 4.929-11 11s4.929 11 11 11 11-4.929 11-11-4.929-11-11-11zm4.828 11.5l-4.608 3.763.679.737 6.101-5-6.112-5-.666.753 4.604 3.747h-11.826v1h11.828z" /></svg><span class="ml-2">Home</span> </li>
                            <li class="pb-4"><svg class="inline " width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                                    <path fill="white" d="M12 0c-6.623 0-12 5.377-12 12s5.377 12 12 12 12-5.377 12-12-5.377-12-12-12zm0 1c-6.071 0-11 4.929-11 11s4.929 11 11 11 11-4.929 11-11-4.929-11-11-11zm4.828 11.5l-4.608 3.763.679.737 6.101-5-6.112-5-.666.753 4.604 3.747h-11.826v1h11.828z" /></svg><span class="ml-2">About Us</span></li>
                            <li class="pb-4"><svg class="inline " width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                                    <path fill="white" d="M12 0c-6.623 0-12 5.377-12 12s5.377 12 12 12 12-5.377 12-12-5.377-12-12-12zm0 1c-6.071 0-11 4.929-11 11s4.929 11 11 11 11-4.929 11-11-4.929-11-11-11zm4.828 11.5l-4.608 3.763.679.737 6.101-5-6.112-5-.666.753 4.604 3.747h-11.826v1h11.828z" /></svg><span class="ml-2">Contact Us</span> </li>
                            <li class="pb-4"><svg class="inline " width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                                    <path fill="white" d="M12 0c-6.623 0-12 5.377-12 12s5.377 12 12 12 12-5.377 12-12-5.377-12-12-12zm0 1c-6.071 0-11 4.929-11 11s4.929 11 11 11 11-4.929 11-11-4.929-11-11-11zm4.828 11.5l-4.608 3.763.679.737 6.101-5-6.112-5-.666.753 4.604 3.747h-11.826v1h11.828z" /></svg><span class="ml-2">Terms of Service</span> </li>
                            <li class="pb-4"><svg class="inline " width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                                    <path fill= "white" d="M12 0c-6.623 0-12 5.377-12 12s5.377 12 12 12 12-5.377 12-12-5.377-12-12-12zm0 1c-6.071 0-11 4.929-11 11s4.929 11 11 11 11-4.929 11-11-4.929-11-11-11zm4.828 11.5l-4.608 3.763.679.737 6.101-5-6.112-5-.666.753 4.604 3.747h-11.826v1h11.828z" /></svg><span class="ml-2">Privacy policy</span> </li>
                        </ul>
                    </div>
                    <div class="mb-5">
                        <h4 class="text-2xl mb-4 underline">Our Service</h4>
                        <ul>
                            <li class="pb-4"><svg class="inline  rounded-full mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="white" d="M16 16v4l8-8-8-8v4h-8.929c-9.059 0-7.134 9.521-6.334 11.418.788-2.445 2.464-3.418 5.371-3.418h9.892z" /></svg>Bus Ticket</li>
                            <li class="pb-4"><svg class="inline rounded-full mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="white" d="M16 16v4l8-8-8-8v4h-8.929c-9.059 0-7.134 9.521-6.334 11.418.788-2.445 2.464-3.418 5.371-3.418h9.892z" /></svg>Tiket system</li>
                            <li class="pb-4"><svg class="inline  rounded-full mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="white" d="M16 16v4l8-8-8-8v4h-8.929c-9.059 0-7.134 9.521-6.334 11.418.788-2.445 2.464-3.418 5.371-3.418h9.892z" /></svg>CBE utility</li>
                            <li class="pb-4"><svg class="inline  rounded-full mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="white" d="M16 16v4l8-8-8-8v4h-8.929c-9.059 0-7.134 9.521-6.334 11.418.788-2.445 2.464-3.418 5.371-3.418h9.892z" /></svg>Concert Ticket </li>
                            <li><svg class="inline  rounded-full mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="white" d="M16 16v4l8-8-8-8v4h-8.929c-9.059 0-7.134 9.521-6.334 11.418.788-2.445 2.464-3.418 5.371-3.418h9.892z" /></svg>Other</li>
                        </ul>
                    </div>
                    <div class="mb-5 ">
                        <h4 class="text-2xl pb-4 underline">Join Our Newsletter</h4>
        ...
        <div class="w-full bg-gray-900 text-gray-500 px-10">
            <div class="max-w-7xl flex flex-col sm:flex-row py-4 mx-auto justify-between items-center">
                <div class="text-center">
                    <div>Copyright <span>&#169;</span> {{ new Date().getFullYear() }}. Comercial Bank of Ethiopia. All right reserved.
                ...
                <div class="text-center text-xl flex flex-row">
                    ...
                    <a class="w-10 h-10 rounded-full bg-gray-400 hover:bg-green-400 mx-2 ml-10"> <svg class="mx-2.5 my-2 animate-beat " width="20" height="20" fill="black" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a class="w-10 h-10 rounded-full bg-gray-400 hover:bg-green-400 mx-2"> <svg class="mx-2.5 my-2 animate-wiggle" xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24">
                    ...
                    <a class="w-10 h-10 rounded-full bg-gray-400 hover:bg-green-400 mx-2"> <svg class="mx-2.5 my-2 animate-bounce" xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24">
                    ...
                    <a class="w-10 h-10 rounded-full bg-gray-400 hover:bg-green-400 mx-2"> <svg class="mx-2.5 my-2 animate-beat" width="24" height="20" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                    ...
                    <a class="w-10 h-10 rounded-full bg-gray-400 hover:bg-green-400 mx-2"> <svg class="mx-2.5 my-2 animate-spin-slow" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M7 11v2.4h3.97c-.16 1.029-1.2 3.02-3.97 3.02-2.39 0-4.34-1.979-4.34-4.42 0-2.44 1.95-4.42 4.34-4.42 1.36 0 2.27.58 2.79 1.08l1.9-1.83c-1.22-1.14-2.8-1.83-4.69-1.83-3.87 0-7 3.13-7 7s3.13 7 7 7c4.04 0 6.721-2.84 6.721-6.84 0-.46-.051-.81-.111-1.16h-6.61zm0 0 17 2h-3v3h-2v-3h-3v-2h3v-3h2v3h3v2z" fill-rule="evenodd" clip-rule="evenodd" /></svg> </a>
                    <div class="">
                        <a href="" class="text-gray-100 scroll-smooth" @click="scrollToTop">
                        <svg class="w-10 h-10  my-2 animate-pulse absolute right-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
