  ...
  <Layout>
    <section class="max-w6xl mx-auto px-4 lg-px-6 py-12">
      <div class="w-full text-center pb-8">
        ...
        <h1
          class="font-bold text-3xl md-text-4xl lg-text-5xl font-heading text-gray-500 pb-2"
        >
        ...
        <p class="text-gray-500 font-normal text-base">
          ...
          libero maiores molestias quia nostrum, eaque labore nisi optio
          architecto recusandae tenetur? Illo eligendi quo minus, quae ea
          tempora accusantium!
        </p>
      </div>
        ...
        <div class="bg-white rounded-lg p-6">
          ...
          <div>
            <p class="text-gray-400 leading-loose ">
              ...
              aspernatur ad repellendus magnam provident dolores consectetur
              nemo sapiente a totam, deleniti recusandae quasi distinctio hic
              nesciunt. Quam pariatur officia odio?
            </p>
          </div>
        </div>
        <div class="bg-white rounded-lg p-6">
