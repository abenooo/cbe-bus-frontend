<template>
<Layout>
    <form class="bg-white shadow-xl mb-4 flex flex-wrap justify-center mx-21 md:flex-2  sm:flex-1">
        <div class="w-full md:w-1/3 bg-gray-700 p-6 text-white mt-10">
            ...
            <div class="mb-4">
                <label class="block text-sm mb-4">Select Departure
                    <input class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="email" placeholder="Email" />
                </label>
            </div>
            <div class="mb-3">
                <label class="block text-sm mb-4">Select Destination
                    <input class="appearance-none border w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" type="password" placeholder="Password" />
                </label>
            </div>
            <div class="mb-4">
                <label class="block text-sm mb-4">Date of Journey
            ...
            <div class="flex flex-row">
                <a href="/validation"> <button class="mt-8 mb-4 py-2 px-14 rounded-full text-center bg-green-500 text-white tracking-widest hover:bg-green-700 transition duration-75">Book Now <svg class="inline ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                        </svg></button></a>
                <a href="/" class="ml-7"> <button class="mt-8 mb-4 py-2 px-14 rounded-full text-center bg-green-500 text-white tracking-widest hover:bg-green-700 transition duration-75">Return Back <svg class="inline" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col justify-between px-8 bg-gray-700 mt-10 ">
            <g-image class="w-full h-full" src="https://www.safaribay.net/wp-content/uploads/2020/04/Odaa-Bus.jpg" alt=""></g-image>

            <hr class="block w-full mb-4 border-0 border-t border-gray-300" />

            <div class="flex flex-wrap justify-center">
                <div class="w-full sm:w-1/2 sm:pr-2 mb-3 sm:mb-0">
                    <button class="w-full bg-blue-800 hover:bg-blue-900 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline" type="button">Go To Offical website</button>
                </div>
